        ...
        <section className="about-values">
          <div className="about-container">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="about-section-label centered">
                <span>03</span>
                <i />
                <p>THE WAY WE CARE</p>
              </div>
              ...
              <h2>
                Simple principles.
                <br />
                <em>Meaningful care.</em>
              </h2>

              <p>
                The experience we want every patient to have
                is built on a few things we never compromise on.
              </p>
            </motion.div>
